...
import com.xylon.imageprobe.activities.FilterDialogFragment;
...
public class FragmentNavigationDrawer extends DrawerLayout {
  private ActionBarDrawerToggle drawerToggle;
	...
	public void addNavItem(String navTitle, String windowTitle, Class<? extends Fragment> fragmentClass,Bundle bundle) {
		drawerAdapter.add(navTitle);
		drawerNavItems.add(new FragmentNavItem(windowTitle, fragmentClass,bundle));
	}
	...
	public void selectDrawerItem(int position) {
		...
		try {
			fragment = (DialogFragment) navItem.getFragmentClass().newInstance(); // hack
		...
		if ( prev != null) fragmentManager.beginTransaction().remove(prev);
		Fragment content = fragmentManager.findFragmentById(R.id.content_frame);
		if ( content != null ) fragmentManager.beginTransaction().remove(content);
